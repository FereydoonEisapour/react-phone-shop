  ...
  return (
    <div className="sidebar  container col-12 col-md-12  " id="sidebar">
      <div className="sidebar__content shadow   m-2 d-flex row justify-content-center">
        <div className="mt-2">
          Price
          <button className=" btn btn-primary w-100 mt-2" onClick={sortByPriceDown}>
            Down
          </button>
          <button className=" btn btn-primary w-100 mt-2 " onClick={sortByPriceUp}>
            Up
          </button>
        </div>
        <div className="container mt-3  ">
          ...
          <div className="row  px-lg-3" onChange={AllProducts}>
            <label className="d-flex justify-content-between py-1   w-100 mt-2 ">
              ALL
              <input value="" type="radio" name="product" />
            </label>
            <label className="d-flex justify-content-between py-1   w-100">
              APPLE
